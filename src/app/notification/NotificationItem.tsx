...
const NotificationItem = ({ data }: { data: NotificationData }) => {
  ...
  return <div
    ...
    onClick={handleClick} >
    <div
      className={`flex items-center mt-3 border-y-slate-600 border-y-[1px] py-4 px-2 justify-center w-[80vw] lg:w-[40dvw] gap-2 flex-col ${isRead ? "opacity-100" : "bg-slate-900 opacity-60"} `}>
